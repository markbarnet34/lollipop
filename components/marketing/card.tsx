...
import type { ValidIcon } from "../common/icons";
...
export function CardTitle({ children }: { children: React.ReactNode }) {
  return (
    <h3 className="bg-gradient-to-tl from-0% from-[hsl(var(--muted))] to-40% to-[hsl(var(--foreground))] bg-clip-text text-center font-heading text-3xl text-transparent">
      {children}
    </h3>
  );
}
