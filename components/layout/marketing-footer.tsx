      ...
      <Shell className="grid gap-6">
        <div className="grid grid-cols-2 gap-6 md:grid-cols-5">
          <div className="col-span-2 flex flex-col gap-3">
            <div>
              ...
              <p className="mt-2 font-light text-muted-foreground text-sm">
                Empowering users to reclaim wasted tokens by automating gas fee
                refunds on EVM-compatible blockchains.
                <br />
          ...
          <div className="order-2 flex flex-col gap-3 text-sm">
            ...
            <FooterLink href="https://consensys.io/blog" label="Blog" />
            <FooterLink href="/pricing" label="Pricing" />
            <FooterLink href="https://consensys.io/docs" label="Docs" />
          </div>
          ...
          <div className="order-3 flex flex-col gap-3 text-sm">
            ...
            <FooterLink href="/claim-gas/checker" label="Gas Checker" />
            <FooterLink
